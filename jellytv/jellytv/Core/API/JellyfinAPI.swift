...
struct JellyfinAPI {
    ...
    func item(id: String) async throws -> JellyfinItem {
        try await get(
            ...
            query: [URLQueryItem(name: "Fields", value: "Overview,UserData,MediaSources,RunTimeTicks,Size,ChildCount,SeriesId,SeriesPrimaryImageTag,CanDelete,ParentId,SeasonId,SeasonName,SeriesName,CommunityRating,CriticRating,OfficialRating,PremiereDate,Studios,ImageTags")],
